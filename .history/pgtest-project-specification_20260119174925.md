...
- [ ] Pool de conexões PostgreSQL por Test-ID com locks (sync.RWMutex)
- [ ] Implementar GetOrCreateSession com locks para thread-safety
...
- [ ] Testes básicos de conexão e concorrência
