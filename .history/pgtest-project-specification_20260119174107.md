...
public function handle($request, Closure $next)
{
    ...
    if ($testId) {
        // Passa Test-ID para o PGTest via application_name
...
**Importante:** O Test-ID é usado apenas pelo PGTest para roteamento interno. O PostgreSQL real não recebe essa informação - o PGTest remove/modifica o `application_name` antes de conectar ao PostgreSQL.
