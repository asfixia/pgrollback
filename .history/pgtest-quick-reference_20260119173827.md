...
// Opção 1: Via application_name na URI de conexão (mais simples)
// No middleware, modificar a connection string:
DB::connection()->getPdo()->exec("SET application_name = 'pgtest_{$testId}'");

// Opção 2: Via parâmetro customizado na URI
// postgresql://user:pass@pgtest-host:5432/mydb?pgtest.test_id=abc123
```
