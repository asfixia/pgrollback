...
**Método Principal: Via Database Name**
- Laravel conecta com: `database=test_abc123_mydb`
- PGTest extrai: `abc123` (regex: `^test_([a-zA-Z0-9_]+)_`)

**Método Alternativo: Via Application Name**
- Laravel conecta com: `application_name=test_abc123`
- PGTest extrai: `abc123` (regex: `^test_(.+)$`)
